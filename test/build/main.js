...
server.get("/users/:id", (req, res) => {
  ...
  if (!user) {
    res.statusCode = 404;
    res.json({
      error: "Maaf user yang kamu cari tidak ada!"
    });
  }
...
server.post("/users", (req, res) => {
  // userId -> uuid
  // body-parser
  const userId = uuid_v4__WEBPACK_IMPORTED_MODULE_2___default()();
...
server.patch("/users/:id", (req, res) => {
  ...
  users = users.map(item => {
    if (item.id === req.params.id) {
      result = _objectSpread(_objectSpread({}, item), req.body);
      return result;
    }
...
module.exports = __webpack_require__(/*! C:\Users\PRO\blibliapp_team3\test\src/index.js */"./src/index.js");
