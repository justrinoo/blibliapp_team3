    ...
    render() {
        return (
            <div>
                ...
                <h3 class="text-center mt-5" style={{ textAlign: "center" }}><img src={Bag} alt="Logo" style={{ height: "40px" }} />Bag</h3>

                <div class="container">

                    <div class="row mt-5 bg-light">
                        <div class="col-sm">
                            <input type="checkbox" name="" id="" class="mr-2" /><span class="font-weight-bold">Pilih Semua Product</span>
                        </div>
                ...
                <div class="container mt-3">
                    <input type="checkbox" name="" id="" class="mr-2" /><span class="font-weight-bold" style={{ fontSize: "12px" }}><img src={Logo} alt="Logo" class="mr-2" />Blibli.com</span>
                    <hr />
                    <div class="row">
                        <div class="col-sm">
                            <p>
                                <input type="checkbox" name="" id="" class="mr-2" /><span><img src={Product} alt="Harddisk" style={{ height: "80px", width: "70px" }} class="mr-2" />Mouse Gaming</span>
                            </p>
                        </div>
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <button onClick={this.handleMinus} class="">-</button>
                ...
                <div class="container">
                    <div class="row bg-light mt-3">
                        ...
                        <div class="col-sm">
                            <button type="button" class="btn btn-warning float-right mt-3">Chekout</button>
                            <p>Total Belanja</p>
