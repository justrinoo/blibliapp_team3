					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<ul class="list-group list-group-flush">
											<li class="list-group-item"><img src={PesonaLogo} alt="Logo" style={{ height: "30px", marginRight: "15px" }} />Galeri Indonesia</li>
											<li class="list-group-item"><img src={LogoCart} alt="logo" style={{ height: "30px", marginRight: "15px" }} />BlibliMart</li>
											<li class="list-group-item"><img src={TabletLogo} alt="logo" style={{ height: "30px", marginRight: "15px" }} />Handphone dan Tablet</li>
											<li class="list-group-item"><img src={Computer} alt="logo" style={{ height: "30px", marginRight: "15px" }} />Komputer & Laptop</li>
											<li class="list-group-item"><img src={Camera} alt="logo" style={{ height: "30px", marginRight: "15px" }} />Kamera</li>
										</ul>
									</div>
						...
						<div class="input-group md-form form-sm form-1 pl-0 w-50 ml-5" >
							<div class="input-group-prepend" >
								<span class="input-group-text purple lighten-3 ml-3" style={{ borderRadius: '0px' }} id="basic-text1"><i class="fas fa-search text-white"
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<p type="button" class="ml-auto mt-4 text-white" data-toggle="modal" data-target="#bagModal">
								<img src={Bag} alt="" />
							...
							<div class="modal fade" id="bagModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											<img src={LogoShop} alt="Logo" style={{margin: "auto", display: "block"}} />
											<h6 class="font-weight-bold" style={{textAlign: "center"}}>Lho, Kok Sepi?</h6>
											<p class="text-muted" style={{textAlign: "center"}}>Mau diisi apa ya Bag sebesar ini? Coba masukkan produk yang sudah kebawa mimpi.
											Habis belanja bisa dapat poin Blibli Rewards lagi!
											</p>
										</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
